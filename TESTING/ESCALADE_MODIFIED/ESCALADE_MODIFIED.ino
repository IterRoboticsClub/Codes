...
else if((surface[0]==1)&&(surface[1]==1))
{
  decide=2;
  pid_black();
  Serial.println(decide);
}
else if((surface[0]==1)&&(surface[1]==0)) 
{
Serial.print("Im in 1");
  //WHITE SURFACE RIGHT TURN BLACK LINE
   if((sensor[0]==1)&&(sensor[1]==1)&&(sensor[2]==0)&&(sensor[3]==0)&&(sensor[4]==0)&&(sensor[5]==0)) // 1 1 0 0 0 0
    {
...
else if((surface[0]==0)&&(surface[1]==1))  
{
  
  //WHITE SURFACE LEFT TURN BLACK LINE
  
   if((sensor[0]==0)&&(sensor[1]==0)&&(sensor[2]==0)&&(sensor[3]==0)&&(sensor[4]==1)&&(sensor[5]==1)) // 0 0 0 0 1 1
    {
      Serial.print("I m in 3");
     halt();
     forward();
     digitalWrite(2,LOW);
     digitalWrite(4,HIGH);
...
void display_values()
{
  ...
  Serial.println("\n----------------------------------------------------------------------");
  Serial.println("Surface 1 =");
  Serial.print(surface[0]);
  Serial.println("Surface 2 =");
