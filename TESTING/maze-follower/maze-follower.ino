...
void decide_path()
{
 if(sensor[5]==0)
 {
   if((sensor[0]==0)&&(sensor[1]==0)&&(sensor[2]==0)&&(sensor[3]==1)&&(sensor[4]==1))    //WHITE-WHITE-BLACK-BLACK-BLACK
   {
     turn_right();
   }
 else if(sensor[5]==1)
 {
   ...
   else if((sensor[0]==1)&&(sensor[1]==1)&&(sensor[2]==1)&&(sensor[3]==1)&&(sensor[4]==0)) //WHITE-WHITE-BLACK-BLACK-BLACK
   {
     turn_right();
   }
