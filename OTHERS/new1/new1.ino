...
void loop(){
  ...
  */
  ...
  for(int i = 0; i < 5; i++){
     ...
     */
    if(lineState[i] > thres) lineState[i] = 1;
    else lineState[i] = 0;
...
{
    if((lineState[0]==1)&&(lineState[1]==1)&&(lineState[2]==0)&&(lineState[3]==1)&&(lineState[4]==1))
    {
    digitalWrite(2,HIGH);
    digitalWrite(4,LOW);
    digitalWrite(7,LOW);
    ...
    else if((lineState[0]==1)&&(lineState[1]==0)&&(lineState[2]==1)&&(lineState[3]==1)&&(lineState[4]==1))
    {
    digitalWrite(2,HIGH);
    digitalWrite(4,LOW);
    digitalWrite(7,HIGH);
    ...
    else if((lineState[0]==0)&&(lineState[1]==1)&&(lineState[2]==1)&&(lineState[3]==1)&&(lineState[4]==1))
    {
    digitalWrite(2,HIGH);
    digitalWrite(4,LOW);
    digitalWrite(7,HIGH);
    ...
    else if((lineState[0]==1)&&(lineState[1]==1)&&(lineState[2]==1)&&(lineState[3]==0)&&(lineState[4]==1))
    {
    digitalWrite(2,LOW);
    digitalWrite(4,HIGH);
    digitalWrite(7,LOW);
    ...
    else if((lineState[0]==1)&&(lineState[1]==1)&&(lineState[2]==1)&&(lineState[3]==1)&&(lineState[4]==0))
    {
    digitalWrite(2,LOW);
    digitalWrite(4,HIGH);
    digitalWrite(7,LOW);
    ...
    else if((lineState[0]==1)&&(lineState[1]==1)&&(lineState[2]==1)&&(lineState[3]==0)&&(lineState[4]==0))
    {
    digitalWrite(2,LOW);
    digitalWrite(4,HIGH);
    digitalWrite(7,LOW);
    ...
    else if((lineState[0]==0)&&(lineState[1]==0)&&(lineState[2]==0)&&(lineState[3]==0)&&(lineState[4]==0))
    {
    digitalWrite(2,HIGH);
    digitalWrite(4,LOW);
    digitalWrite(7,LOW);
